      ...
      <div className="pt-24 pb-8 container mx-auto px-4">
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl md:text-4xl font-bold mb-4">
            {query ? `نتائج البحث عن "${query}"` : "ابحث عن أفلامك المفضلة"}
          </h1>
              ...
              if (item.media_type === "person") {
                return (
                  ...
                  >
                    ...
                    <p className="text-xs text-muted-foreground text-center">ممثل/ة</p>
                  </Link>
                );
              }
              return (
        ...
        {!isLoading && !query && (
          <div className="text-center py-16">
            ...
            <p className="text-muted-foreground">ابحث عن أفلامك ومسلسلاتك المفضلة</p>
          </div>
        )}
      </div>
