...
export default function WatchMovie() {
  ...
  const videoUrl = getVideoUrl(selectedServer, movie.id, "movie");
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="relative pt-24 pb-8 container mx-auto px-4">
        ...
        <nav className="flex items-center gap-2 text-sm text-muted-foreground mb-6">
          ...
          <Link to="/category/movie/all" className="hover:text-primary transition-colors">أفلام</Link>
          <ArrowRight className="w-4 h-4 rtl-flip" />
        ...
        {/* Similar Movies */}
        {similar.length > 0 && (
          <ContentRow title="أفلام مشابهة" items={similar} type="movie" />
        )}
      </div>
