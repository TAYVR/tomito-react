...
export default function WatchTV() {
  ...
  const [selectedServer, setSelectedServer] = useState(VIDEO_SERVERS[0]);
  ...
  const videoUrl = `${selectedServer.tvUrl}${show.id}/${selectedSeason}/${selectedEpisode}`;
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="relative pt-24 pb-8 container mx-auto px-4">
        ...
        <nav className="flex items-center gap-2 text-sm text-muted-foreground mb-6">
          ...
          <Link to="/category/tv/all" className="hover:text-primary transition-colors">مسلسلات</Link>
          <ArrowRight className="w-4 h-4 rtl-flip" />
        ...
        <div className="flex flex-col lg:flex-row gap-8 mb-8">
          ...
          <div className="flex-1">
            ...
            <p className="text-muted-foreground leading-relaxed mb-6">
              {show.overview || "لا يوجد وصف متاح لهذا المسلسل."}
            </p>
            ...
            {cast.length > 0 && (
              <div className="flex items-center gap-2 text-sm">
                ...
                <span className="text-muted-foreground">الممثلون:</span>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-3">
            {episodes.map((episode) => (
              ...
              >
                ...
                <p className="font-medium text-sm line-clamp-1">الحلقة {episode.episode_number}</p>
        ...
        {cast.length > 0 && (
          <div className="mb-8">
            <h2 className="text-xl font-bold mb-4">طاقم العمل</h2>
        ...
        {/* Similar Shows */}
        {similar.length > 0 && (
          <ContentRow title="مسلسلات مشابهة" items={similar} type="tv" />
        )}
      </div>
